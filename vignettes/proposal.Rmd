...
While Bioconductor has many packages for annotation, mapping disease descriptions is a relatively underserved area. An R-based interface to the Human Phenotype Ontology (HPO) would not only increase use, but also enable better open science. Further, we anticipate that the variety of ID and annotation types available in a one-stop manner from Monarch Initiative would be valued by the community.
